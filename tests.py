...
class TestBooksCollector:
    ...
    def test_set_book_rating_add_rating_to_nonexistent_book_rating_is_none(self):
        ...
        assert collector.get_book_rating(book) is None, 'Rating of nonexistent book is set'
    ...
    def test_add_book_in_favorites_add_new_book_book_in_favorites(self):
        ...
        assert book in collector.get_list_of_favorites_books(), 'Book isnt added to favorites'
